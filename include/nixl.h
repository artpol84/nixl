...
class nixlAgent {
    ...
    public:
        ...
        nixlBackendEngine *createBackend(nixlBackendInitParams *);
        ...
        nixlTransferRequest *createTransferReq (nixlDescList<nixlBasicDesc>& local_desc,
                                                nixlDescList<nixlBasicDesc>& remote_desc,
        ...
        nixlMetadata getMetadata ();

        // Load other agent's metadata and unpack it internally
        int loadMetadata (nixlMetadata remote_metadata);
